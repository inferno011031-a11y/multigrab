...
export function LanguageSelector({ currentLocale = 'en' }: { currentLocale?: SupportedLocale }) {
  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-44 rounded-2xl border border-neutral-800 bg-neutral-950 p-1.5 shadow-2xl backdrop-blur-xl animate-in fade-in zoom-in-95 duration-150 z-50 max-h-64 overflow-y-auto">
