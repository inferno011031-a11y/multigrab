...
export function MediaInspector({ metadata, onDownload, isProcessing }: MediaInspectorProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto mt-8 rounded-3xl border border-neutral-800 bg-neutral-950 p-6 sm:p-8 shadow-2xl">
      {/* Top Media Header Info */}
      <div className="flex flex-col md:flex-row gap-6 items-start">
        {/* Thumbnail preview */}
        <div className="relative w-full md:w-72 shrink-0 aspect-video rounded-2xl overflow-hidden bg-neutral-900 border border-neutral-800 shadow-md group">
          {metadata.thumbnail ? (
          ...
          {metadata.durationFormatted && (
            <div className="absolute bottom-2 right-2 flex items-center gap-1 rounded-md bg-black/90 px-2 py-0.5 text-xs font-medium text-white border border-neutral-800">
          ...
          {/* Platform Badge */}
          <div className="absolute top-2 left-2 rounded-md bg-black/90 px-2 py-0.5 text-[10px] font-bold text-white uppercase tracking-wider border border-neutral-800">
        ...
        <div className="flex-1 flex flex-col justify-between w-full">
          ...
          {/* Tabs Filter */}
          <div className="mt-6 flex flex-wrap items-center gap-2 border-b border-neutral-800 pb-3">
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {videoFormats.map((format, idx) => (
              <div
                ...
                className="group relative flex flex-col justify-between rounded-2xl border border-neutral-800 bg-neutral-900/60 p-4 transition-all hover:border-neutral-700 hover:bg-neutral-900"
              >
                <div>
                  <div className="flex items-center justify-between">
                    ...
                    <span className="rounded-md bg-neutral-800 px-2 py-0.5 text-[11px] font-semibold text-neutral-300 uppercase border border-neutral-700/50">
                ...
                <button
                  ...
                  className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl bg-white py-2.5 text-xs font-bold text-black transition-all hover:bg-neutral-200 disabled:opacity-50 cursor-pointer"
                >
