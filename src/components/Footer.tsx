...
export function Footer() {
  return (
    <footer className="border-t border-zinc-800/80 bg-zinc-950/90 py-12 px-4 sm:px-6 lg:px-8 text-zinc-400">
      <div className="mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-10 border-b border-zinc-800/60">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/spotify-downloader" className="hover:text-emerald-400 transition-colors">
              ...
              <li>
                <Link href="/instagram-downloader" className="hover:text-pink-400 transition-colors">
                  Instagram Reels Downloader
                </Link>
              </li>
              <li>
                <Link href="/twitter-downloader" className="hover:text-sky-400 transition-colors">
                  X / Twitter Video Downloader
                </Link>
              </li>
              <li>
                <Link href="/facebook-downloader" className="hover:text-blue-400 transition-colors">
                  Facebook Video Downloader
                </Link>
              </li>
              <li>
                <Link href="/reddit-downloader" className="hover:text-orange-400 transition-colors">
                  Reddit Video Downloader with Audio
                </Link>
              </li>
              <li>
                <Link href="/pinterest-downloader" className="hover:text-rose-400 transition-colors">
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-zinc-500 gap-4">
          <div>
            © {new Date().getFullYear()} <strong className="text-zinc-300">MediaDrop</strong>. All rights reserved.
          </div>
