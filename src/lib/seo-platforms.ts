...
export const SEO_PLATFORMS: Record<string, SeoPlatformData> = {
  ...
  'youtube-to-mp4': {
    ...
    heading: 'YouTube to MP4 Video Converter',
  ...
  'youtube-1080p-downloader': {
    ...
    heading: 'YouTube 1080p Full HD Downloader',
  ...
  'youtube-4k-downloader': {
    ...
    heading: 'YouTube 4K Ultra HD Downloader',
  ...
  'spotify-downloader': {
    ...
    heading: 'Spotify Song & Music Downloader',
    ...
    relatedTools: [
      { name: 'Spotify to MP3', slug: 'spotify-to-mp3', desc: 'Convert Spotify links directly to 320kbps MP3' },
      { name: 'Spotify MP3 Downloader', slug: 'spotify-mp3-downloader', desc: 'Download Spotify tracks in high quality MP3' },
      { name: 'YouTube to MP3', slug: 'youtube-to-mp3', desc: 'Extract studio-quality 320kbps MP3 audio' },
    ],
  },
  'spotify-mp3-downloader': {
    slug: 'spotify-mp3-downloader',
    platform: 'spotify',
    title: 'Spotify MP3 Downloader — MultiGrab: Free 320kbps Music Converter',
    metaDescription: 'Download and convert Spotify songs to high-fidelity 320kbps MP3 audio with full album artwork for free with MultiGrab.',
    heading: 'Spotify MP3 Downloader',
    subheading: 'Download Spotify tracks, playlists, and albums in universal 320 kbps MP3 audio format for offline music playback on any device.',
    heroBadge: 'MultiGrab • Spotify to 320kbps MP3',
    iconName: 'spotify',
    features: [
      'Download Spotify tracks directly in 320 kbps MP3 format',
      'Automatic ID3 metadata tagging (artist, title, album art)',
      'Free with no Spotify Premium account or app installation required',
      'Fast high-speed cloud extraction',
    ],
    steps: [
      { title: 'Copy Spotify Link', desc: 'Copy the track or album URL from the Spotify app or web player.' },
      { title: 'Paste in MultiGrab', desc: 'Paste into the search field above and click Download.' },
      { title: 'Download MP3 Audio', desc: 'Select 320 kbps MP3 to download your music file instantly.' },
    ],
    faqs: [
      { q: 'Is it free to download Spotify MP3s?', a: 'Yes, MultiGrab is 100% free with no subscriptions or download limits.' },
      { q: 'What is the quality of the downloaded MP3?', a: 'Audio is extracted at up to 320 kbps constant bitrate for optimal clarity.' },
    ],
    exampleUrl: 'https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT',
    relatedTools: [
      { name: 'Spotify Downloader', slug: 'spotify-downloader', desc: 'Download Spotify songs & albums' },
      { name: 'Spotify to MP3', slug: 'spotify-to-mp3', desc: 'Convert Spotify links to MP3' },
    ],
  },
  'spotify-to-mp3': {
    slug: 'spotify-to-mp3',
    ...
    exampleUrl: 'https://open.spotify.com/track/4cOdK2wGLETKBW3PvgPWqT',
    relatedTools: [
      { name: 'Spotify MP3 Downloader', slug: 'spotify-mp3-downloader', desc: 'Download Spotify tracks in 320kbps MP3' },
  ...
  'tiktok-downloader': {
    ...
    relatedTools: [
      { name: 'TikTok to MP3', slug: 'tiktok-to-mp3', desc: 'Extract TikTok sounds and music in MP3' },
      { name: 'Instagram Reels Downloader', slug: 'instagram-reels-downloader', desc: 'Save Instagram Reels in HD' },
    ],
  },
  'tiktok-to-mp3': {
    slug: 'tiktok-to-mp3',
    ...
    heading: 'TikTok to MP3 Audio Downloader',
    ...
    exampleUrl: 'https://www.tiktok.com/@tiktok/video/7106594312292453678',
    relatedTools: [
      { name: 'TikTok Video Downloader', slug: 'tiktok-downloader', desc: 'Download TikTok videos without watermark' },
      { name: 'YouTube to MP3', slug: 'youtube-to-mp3', desc: 'Convert YouTube to 320kbps MP3' },
    ],
  },
  'instagram-downloader': {
    ...
    relatedTools: [
      { name: 'Instagram Reels Downloader', slug: 'instagram-reels-downloader', desc: 'Save Instagram Reels in 1080p HD' },
      { name: 'TikTok Downloader', slug: 'tiktok-downloader', desc: 'Download TikTok videos without watermark' },
    ],
  },
  'instagram-reels-downloader': {
    ...
    exampleUrl: 'https://www.instagram.com/reel/C123456789/',
    relatedTools: [
      { name: 'Instagram Video Downloader', slug: 'instagram-downloader', desc: 'Download Instagram videos and Reels' },
      { name: 'YouTube Shorts Downloader', slug: 'youtube-shorts-downloader', desc: 'Save YouTube Shorts in 1080p HD' },
    ],
  },
  'twitter-downloader': {
    slug: 'twitter-downloader',
    platform: 'twitter',
    title: 'Instant Twitter Video Downloader — MultiGrab: Save Tweets & GIFs',
    ...
    heading: 'Instant Twitter Video Downloader',
    ...
    relatedTools: [
      { name: 'Reddit Video Downloader', slug: 'reddit-downloader', desc: 'Save Reddit videos with synced audio' },
      { name: 'TikTok Downloader', slug: 'tiktok-downloader', desc: 'Download TikTok videos in HD' },
    ],
  },
  'facebook-downloader': {
    ...
    relatedTools: [
      { name: 'Instagram Video Downloader', slug: 'instagram-downloader', desc: 'Download Instagram Reels and videos' },
      { name: 'YouTube Video Downloader', slug: 'youtube-downloader', desc: 'Download YouTube videos in 4K & 1080p' },
    ],
  },
  'reddit-downloader': {
    ...
    relatedTools: [
      { name: 'Twitter Video Downloader', slug: 'twitter-downloader', desc: 'Download X/Twitter videos and GIFs' },
      { name: 'YouTube Video Downloader', slug: 'youtube-downloader', desc: 'Download YouTube videos in 4K & 1080p' },
    ],
  },
  'pinterest-downloader': {
    ...
    relatedTools: [
      { name: 'TikTok Downloader', slug: 'tiktok-downloader', desc: 'Download TikTok videos in HD' },
      { name: 'Instagram Video Downloader', slug: 'instagram-downloader', desc: 'Save Instagram Reels & videos' },
    ],
  },
  'vimeo-downloader': {
    ...
    relatedTools: [
      { name: 'YouTube 4K Downloader', slug: 'youtube-4k-downloader', desc: 'Download 4K Ultra HD videos' },
      { name: 'YouTube Video Downloader', slug: 'youtube-downloader', desc: 'Download YouTube videos in 4K & 1080p' },
    ],
  },
};
